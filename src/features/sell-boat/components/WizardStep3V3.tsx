...
import { BoatFormV3Data } from "../types-v3"
import { Input } from "@/components/ui/input"
import { Label } from "@/components/ui/label"
import { Checkbox } from "@/components/ui/checkbox"
import { Shield, Award, ThumbsUp, Lock } from "lucide-react"

interface WizardStep3V3Props {
...
export function WizardStep3V3({ form }: WizardStep3V3Props) {
        ...
        <div className="grid grid-cols-3 gap-2">
          {CONTACT_METHODS.map((method) => (
            <button
              ...
              type="button"
              onClick={() =>
                setValue("preferredContact", method, { shouldValidate: true })
              }
