      ...
      <div className="mx-auto w-full max-w-7xl space-y-10 px-4 pb-6 pt-4 sm:px-6 lg:px-8">
        ...
        <section className="grid gap-8 lg:grid-cols-[1.4fr_0.6fr]">
          ...
          <div className="space-y-6">
            ...
            <BdpAiExplorer boatTitle={`${MOCK_BOAT.year} ${MOCK_BOAT.make} ${MOCK_BOAT.model}`} />

            <div className="space-y-3">
              <BdpRightPanel title="Features" />
              <BdpRightPanel title="Propulsion" />
              <BdpRightPanel title="Specifications" />
              <BdpRightPanel title="Description" summary={`${MOCK_BOAT.year} ${MOCK_BOAT.make} ${MOCK_BOAT.model}`} />
            </div>
          </div>
          ...
          <aside className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm text-muted-foreground">
                ...
                <p>Browse similar listings below or use the search to find your next boat.</p>
              </CardContent>
            </Card>
          </aside>
        </section>
