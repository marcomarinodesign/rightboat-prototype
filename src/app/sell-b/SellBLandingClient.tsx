...
const TESTIMONIALS = [
  ...
  {
    quote:
      "I was amazed how quickly my sailboat sold. The listing process took less than 10 minutes.",
    name: "Tom R.",
    role: "Sailing boat owner",
    rating: 5,
  },
  {
    quote:
      "Direct contact with buyers made the whole experience so much smoother than going through a broker.",
    name: "Emma K.",
...
export function SellBLandingClient() {
  return (
    <div className="flex flex-col gap-10 lg:gap-10">
      ...
      <section
        className={cn(
          "w-full rounded-2xl px-4 py-12 sm:px-6 lg:flex lg:items-center lg:justify-center lg:gap-5 lg:px-10 lg:py-16",
          "bg-primary"
        )}
