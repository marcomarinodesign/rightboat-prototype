        ...
        <DialogContent className="max-w-sm rounded-2xl" showCloseButton={false}>
          ...
          <div className="flex flex-col gap-2 pt-4">
            <button
              ...
              className="w-full h-10 rounded-xl bg-destructive text-white text-[13px] font-medium hover:opacity-90 transition-opacity"
            >
              Exit anyway
            </button>
            <button
              ...
              className="w-full h-10 rounded-xl border border-[#e4e5e9] text-[13px] font-medium text-foreground hover:bg-[#fafafa] transition-colors"
            >
              Keep editing
            </button>
          </div>
