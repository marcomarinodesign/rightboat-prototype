...
// STATUS: conectado — node-id=80-65, verificar props de variante
...
figma.connect(
  ...
  "https://www.figma.com/design/VOCH4pGubqSYza7CbL30c7/El-Captain-DS?node-id=80-65",
  {
    ...
    // TODO: restaurar figma.enum("Variant") una vez confirmado el nombre de prop en Figma
    example: () => <BoatCard boat={MOCK_BOAT} />,
  }
)
